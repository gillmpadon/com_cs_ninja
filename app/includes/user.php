<?php
$id  = $_SESSION['id'];
$userQuery = "SELECT a.username as username,a.points as points, a.level as level, av.photo as photo, av.intelligence as intelligence, av.strength as strength, av.speed as speed from account a INNER JOIN avatar av on a.avatar = av.id where a.id = $id";
            ...
            <div class="userStats">
                <div class="content">
                    <div class="entry">
                        ...
                        <p><?php echo floor(($points/10)*$user['intelligence']) ?></p>
                    </div>
                    <div class="entry">
                        ...
                        <p><?php echo floor(($points/10)*$user['strength']) ?></p>
                    </div>
                    <div class="entry">
                        ...
                        <p><?php echo floor(($points/10)*$user['speed']); ?></p>
                    </div>
                </div>
            </div>